...
func (v *firebaseAuthContext) User(ctx context.Context, authRequired bool) (facade.UserContext, error) {
	...
	v.userContext = facade.AuthUserContext{ID: v.fbAuthToken.UID}
